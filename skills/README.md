...
| [`editorial`](./editorial/SKILL.md) | Editorial design language for PDFs and HTML pages — cream paper, Fraunces serif, Inter body, configurable accent. Ships a stylesheet, a snippet library, five named palettes, and scripts to scaffold and render to PDF via Chrome headless. | "make this a PDF", "editorial treatment", "Claude's design language", "give this a paper-like layout", "render with editorial" |
